...
if (isset($_POST['btnAdd'])) {
    ...
    //ກວດລະຫັດຊໍ້ໍາ
    $sql = "SELECT empno FROM emp WHERE empno='$emp_id'";
    $result = mysqli_query($link, $sql);
    if (mysqli_num_rows($result) == 1) {
        $error_grade = "ລະຫັດພະນັກງານນີ້ຖືກນຳໃຊ້ແລ້ວ!";
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                $sql = "INSERT INTO emp VALUES('$emp_id', '$emp_name', '$emp_gender', '$emp_dob', '$address', $incentive, '$language', '$image_url', $grade, '$dno')";
                $result = mysqli_query($link, $sql);
                ...
                <div class="card-body bg-light">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="emp_id" id="emp_id" class="form-control" placeholder="ປ້ອນລະຫັດພະນັກງານ">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="emp_name" class="form-label">ຊື່ພະນັກງານ</label>
                                        <div class="input-group">
                                            <input type="text" name="emp_name" id="emp_name" class="form-control" placeholder="ປ້ອນຊື່ພະນັກງານ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="emp_gender" value="M" id="male" class="form-check-input"> <label for="male" class="form-check-label">ຊາຍ</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="emp_gender" value="F" id="female" class="form-check-input"> <label for="female" class="form-check-label">ຍິງ</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="date" name="emp_dob" id="emp_dob" class="form-control" placeholder="ປ້ອນວັນເດືອນປີເກີດ">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="incentive" id="incentive" class="form-control" placeholder="ປ້ອນເງິນອຸດໜຸນ">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="text-center mb-3">
                                    ...
                                    <div id="temp-img">
                                        <img src="image/icons8-user-100.png" alt="" srcset="" width="150" height="180">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="language[]" type="checkbox" value="ອັງກິດ" id="eng">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="language[]" type="checkbox" value="ຈີນ" id="chi">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="language[]" type="checkbox" value="ຫວຽດນາມ" id="viet">
                        ...
                        <div class="text-center">
                            <input type="submit" name="btnAdd" value="ເພີ່ມຂໍ້ມູນ" class="btn btn-primary">
                            &nbsp;&nbsp;
                            <input type="reset" value="ຍົກເລີກ" class="btn btn-warning">
                            &nbsp;&nbsp;
                            <button onclick="window.location.reload(true)" class="btn btn-success">ໂຫຼດຄືນໃໝ່</button>
                        </div>
